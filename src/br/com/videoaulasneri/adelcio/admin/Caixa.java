...
Descrição: Manutenção da Tabela de Caixa de Loja
...
public class Caixa extends JFrame implements ActionListener, MouseListener, KeyListener, FocusListener
{
    ...
    JLabel label_codmaquina          = new JLabel("Código da Impressora.: ");
    JLabel label_serie65             = new JLabel("Série da NFCe(mod.65): ");
...
//Posicao do ultimo cpo da Tabela no Formulario. Utiliz.para Iniciar a exibicao do JTable
        ...
        lab_tabela[2]         = "Nome";
        lab_tabela[3]         = "Código da Impressora";
        lab_tabela[4]         = "Série NFCe";
...
//JOptionPane.showMessageDialog(null,"Comando sql_insert = " + sql_insert);
                    statement.executeUpdate(sql_insert);
                    JOptionPane.showMessageDialog(null, "Gravacao da Tabela de Numeração da Serie realizada com sucesso para o ambiente: PRODUÇÃO !");
...
//JOptionPane.showMessageDialog(null,"Comando sql_insert = " + sql_insert);
                    statement.executeUpdate(sql_insert);
                    JOptionPane.showMessageDialog(null, "Gravacao da Tabela de Numeração da Serie realizada com sucesso para o ambiente: HOMOLOGAÇÃO !");
                } catch(Exception e) {
//                    JOptionPane.showMessageDialog(null, "Erro ao tentar gravar a Tabela de Numeração da Serie para o modelo 65!");
                }
                 clicado = false;
                 preencher_cb_pesquisa("tudo");
                 preencher_jtable("tudo");
