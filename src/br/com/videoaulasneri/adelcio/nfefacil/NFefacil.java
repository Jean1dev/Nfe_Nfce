...
public class NFefacil extends JFrame implements MouseListener, ActionListener, ItemListener {
   ...
   public configNfeFacil obj_conf = new configNfeFacil();
    ...
    String versao = "Versão: 1.2.8 (10/03/2018)";
...
//  itens de menu do painel faturamento
    ...
    JMenuItem fatDevoNf     = new JMenuItem("Devolução Total NFe de Venda");
...
//    JMenuItem admMenu11     = new JMenuItem("Importar/Emitir NFCe");
    ...
    public static String cupomNaTela = "N", infoBalanca = "V";
...
//         panel_configura    = new JPanel();
         ...
         lb_versaoNFe       .setForeground(Color.white);
         lb_versao          .setForeground(Color.white);
...
//         painel_pai         .setBounds(10,60,970,590);
         ...
         lb_titulo          .setBounds(430,  5, 600, 30);
         lb_email           .setBounds(400, 25, 500, 20);
         lb_cidade          .setBounds(400, 38, 500, 20);
...
//JOptionPane.showMessageDialog(null, "Fuso Horario: " + fuso_horario);
                   new br.com.videoaulasneri.adelcio.fatura.NFCe(confat, empresa, tf_usuario.getText(), stat_caixa, fuso_horario, cUF, nome_empresa, endereco_empresa, contatoCupom, uriCupom, informarCnpjCartao, cupomNaTela, infoBalanca).show();
               } else {
...
//System.out.println("Entrou metodo nfefacil.pegaEmailCliente() . . .");        
   ...
   private String formataCpfCnpj(String cnpj_cpf) {
    ...
    public void le_configNfeFacil()
    {
         try
         {
             System.out.println("Arquivo Confignfefacil.txt: " + drive+fsep+"configNfeFacil.txt");
    ...
    private void conectaFatura() {
        ...
        infoBalanca         = xr.getY_infoBalanca();
