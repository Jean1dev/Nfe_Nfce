...
public class Nf_produtos extends JFrame implements ActionListener, MouseListener, KeyListener, FocusListener
{
    ...
    private String fin_nfe;
    private String codigoCfop;

    public Nf_produtos(int empresa, Connection confat, String pedido, String numeronfe, String ufEmit, String ufCDest, String fin_nfe)
    {
    ...
    public boolean check_textField() {
        ...
        if (tf_cod_cfop.getText().equals("")){
           ...
           retorno = false;
            ...
            if (fin_nfe.equals("4") && // devolucao
                  (
                    !getCodigoCfop().equals("1202") && 
                    !getCodigoCfop().equals("2202") && 
                    !getCodigoCfop().equals("1411") && 
                    !getCodigoCfop().equals("2411") && 
                    !getCodigoCfop().equals("5202") && 
                    !getCodigoCfop().equals("5411") && 
                    !getCodigoCfop().equals("6202") && 
                    !getCodigoCfop().equals("6411")
                  )
            ) {
                JOptionPane.showMessageDialog(null, "Para Devolução, CFOP [" + getCodigoCfop() + "] deve ser: 1202, 2202, 1411, 2411, 5202, 5411, 6202 ou 6411 !");
                retorno = false;
            }
        }
...
System.out.println("metodo: preenche_cb_auxiliar - Sql_aux: "+sql_aux);
            ...
            while(rs_aux.next()) {
                ...
                if (tab_cb_tab_box[indice].equals("cfop")) {  //  cfop
                    ...
                    setCodigoCfop(rs_aux.getString("cfop"));
...
//calcula a data do vencto de cada parcela
    ...
    public static void main(String args[])
        {
        JFrame form = new Nf_produtos(3, null, null, null, "PR", "PR", "1");
    ...
    /**
     * @param codigoCfop the codigoCfop to set
     */
