    ...
    public boolean check_textField() {
        ...
        if (tf_preco.getText().equals("0.00")) {
         ...
         if (tf_cofins_cst.getText().length() > 2) {
          ...
          if (
                  !tf_pis_cst.getText().equals("01") &&
                  !tf_pis_cst.getText().equals("06") &&
                  !tf_pis_cst.getText().equals("07") &&
                  !tf_pis_cst.getText().equals("08") &&
                  !tf_pis_cst.getText().equals("99") 
                  ) {
             msg_erro += "Código CST do PIS tem que ser: 01, 06, 07, 08 ou 99!\n";
           retorno = false;
         }
          if (
                  !tf_cofins_cst.getText().equals("01") &&
                  !tf_cofins_cst.getText().equals("06") &&
                  !tf_cofins_cst.getText().equals("07") &&
                  !tf_cofins_cst.getText().equals("08") &&
                  !tf_cofins_cst.getText().equals("99") 
                  ) {
             msg_erro += "Código CST do COFINS tem que ser: 01, 06, 07, 08 ou 99!\n";
           retorno = false;
         }
