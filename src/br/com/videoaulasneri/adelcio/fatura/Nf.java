...
public class Nf extends JFrame implements ActionListener, MouseListener, KeyListener, FocusListener
{
    ...
    JLabel label_dados_fin_nfe       = new JLabel("1-Normal / 4-Devolução ");
    ...
    JLabel label_refNFe              = new JLabel("Chave NFe referenciada: ");
...
//JOptionPane.showMessageDialog(null, "Ambiente: " + lb_ambiente.getText() + " - Motivo: " + lb_status.getText());
    ...
    //Gera cor frente dos lanbels setForegroundColor()
        ...
        label_dados_fin_nfe     .setForeground(Color.blue);
        ...
        label_refNFe            .setForeground(Color.black);
    ...
    //alinha os labels a direita
        ...
        label_dados_fin_nfe     .setHorizontalAlignment(JLabel.CENTER);
        ...
        label_refNFe            .setHorizontalAlignment(JLabel.RIGHT);
    ...
    //Gera cor frente de fundo texfields setBackroundColor()
        ...
        tf_fin_nfe               .addActionListener(this);
        tf_fin_nfe               .addKeyListener(this);
        ...
        label_dados_fin_nfe      .setBounds(730,275,200,20);
        ...
        label_fin_nfe            .setBounds(660,300,130,20);
        tf_fin_nfe               .setBounds(810,300,20,20);
...
/*
        ...
        label_refNFe             .setBounds(100,550,200,20);
        tf_refNFe                .setBounds(300,550,300,20);
 *
 */
        ...
        label_refNFe             .setBounds(70,450,230,20);
        tf_refNFe                .setBounds(300,450,330,20);
        ...
        getContentPane()      .add(label_dados_fin_nfe);
        getContentPane()      .add(label_fin_nfe);
        getContentPane()      .add(tf_fin_nfe);
        ...
        getContentPane()      .add(label_refNFe);
        getContentPane()      .add(tf_refNFe);
...
//JOptionPane.showMessageDialog(null,"Critica 3 ");
        ...
        try
        {
            ...
            while (resultset.next()){
                String codFinNfe = resultset.getString("fin_nfe");
                String finalidade = codFinNfe.equals("1") ? "Normal" : "Devolução";
                modelo.addRow(new Object [] {
                resultset.getString("pedido"),
                resultset.getString("numero_nfe"),
                resultset.getString("serie_nfe"),
                finalidade,
...
//System.out.println("nf.mostra_conteudo_nos_campos() - Passou 2.2.3 . . .");
               ...
               tf_refNFe              .setText(resultset.getString("refnfe"));
...
//               fin_nfe               = resultset.getString("fin_nfe");
               tf_fin_nfe.setText(resultset.getString("fin_nfe"));
               tf_num_nfe_fat        .setBackground(Color.white);
               tf_data_canc          .setBackground(Color.white);
               tf_tipo_nfe           .setBackground(Color.white);
...
//Desabilita campo chave para alteracao/exclusao 
           ...
           if (tf_fin_nfe.getText().equals("1") || tf_fin_nfe.getText().equals("4")) {  //  habilita botoes de atualizacao somente p/fin_nfe NORMAL
                ...
                if (Integer.parseInt(tf_numero_nfe.getText()) > 0) {
                    ...
                    if (check_textField()) {
                        if (gravar()) {
                            ...
                            new br.com.videoaulasneri.adelcio.fatura.Nf_produtos(empresa, connection, pedido, tf_numero_nfe.getText(), UFEmit, pegaUfDest(), tf_fin_nfe.getText()).show();
 ...
 */
    ...
    private void setTipo_nfe() {
        if (tf_fin_nfe.getText().equals("1")) {
            tf_tipo_nfe.setText("Normal");
            tf_refNFe.setEnabled(false);
        } else if (tf_fin_nfe.getText().equals("2")) {
            tf_tipo_nfe.setText("Complementar");
            tf_tipo_nfe              .setBackground(Color.yellow);
            tf_refNFe.setEnabled(false);
        } else if (tf_fin_nfe.getText().equals("3")) {
            tf_tipo_nfe.setText("Ajuste");
            tf_tipo_nfe              .setBackground(Color.yellow);
            tf_refNFe.setEnabled(false);
        } else if (tf_fin_nfe.getText().equals("4")) {
            tf_tipo_nfe.setText("Devolucao");
            tf_tipo_nfe              .setBackground(Color.yellow);
            tf_num_nfe_fat          .setBackground(Color.yellow);
            tf_refNFe.setEnabled(true);
        } else {
...
//Limpa filtros da inclusao anterior nos comboBox auxiliares 
    ...
    public boolean check_textField() {
        ...
        if (
                !tf_fin_nfe.getText().equals("1") &&    // Normal
//                !tf_fin_nfe.getText().equals("2") &&  // Complementar
//                !tf_fin_nfe.getText().equals("3") &&  // Ajuste
                !tf_fin_nfe.getText().equals("4")       //  Devolução
                ){
           txtMsg +=  "\nCodigo Finalidade NFe deve ser 1(Normal) 4(Devolução) !";
        }
        if ( tf_refNFe.getText() == null ) tf_refNFe.setText("");
        if (tf_fin_nfe.getText().equals("4") && tf_refNFe.getText().length() < 44){
           txtMsg +=  "\nPara finalidade de Devolução, Nfe referenciada tem que ter 44 caracteres!";
        }
        if (!tf_fin_nfe.getText().equals("4")){
            tf_refNFe.setText("");
        }
 ...
 */
                ...
                sql_insert = "insert into nf ( "
                 ...
                 sql_insert += "chave_nfe, "+
                        ...
                        +"cofins_bc, "+"cofins_vlr, num_NFe_fat, fin_NFe, refnfe "
                        +") values ("
                        +empresa+", "
                        +tf_pedido.getText() + ", "
...
*/
    ...
    public void keyPressed(KeyEvent e) {
        ...
        } else if (e.getSource() == tf_fin_nfe) {
            System.out.println("keyPressed - tf_fin_nfe . . .");
           setTipo_nfe();
        }
    }
